...
| HACK-07 | Current user / hackathon auth                               | IMPLEMENTED_NOT_VERIFIED | DB-backed demo selector; `x-user-id`; server resolution                                          | Manual flow blocked; replace with SSO later                                      |
